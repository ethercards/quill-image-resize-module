...
var MockDate = /** @class */ (function () {
  ...
  MockDate.prototype.setDate = function (date) {
    this.date = date;
  };
  MockDate.prototype.setHours = function (h) {
    this.hours = h;
  };
  MockDate.prototype.setMinutes = function (m) {
    this.minutes = m;
  };
  MockDate.prototype.setSeconds = function (s) {
    this.seconds = s;
  };
  MockDate.prototype.setMilliseconds = function (ms) {
